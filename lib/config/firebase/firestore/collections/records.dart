...
class RecordsDocument {
  ...
  factory RecordsDocument.fromMap(Map<String, dynamic> map) => RecordsDocument(
        id: map[RecordsAttrs.id],
        date: (map[RecordsAttrs.date] as Timestamp).toDate().toUtc(),
        ...
        barrel: Exercises.fromMap(map[RecordsAttrs.barrel]),
        cadillac: Exercises.fromMap(map[RecordsAttrs.cadillac]),
        stepChair: Exercises.fromMap(map[RecordsAttrs.stepChair]),
        reformer: Exercises.fromMap(map[RecordsAttrs.reformer]),
        columpio: Exercises.fromMap(map[RecordsAttrs.columpio]),
        solo: Exercises.fromMap(map[RecordsAttrs.solo]),
        accessories: Accessories.fromMap(map[RecordsAttrs.accessories]),
        physiotherapy: Physiotherapy.fromMap(map[RecordsAttrs.physiotherapy]),
        intercurrences: map[RecordsAttrs.intercurrences],
        comments: map[RecordsAttrs.comments],
      );
  ...
  RecordsDocument copyWith({required Map<String, dynamic> newAttrs}) {
    ...
    return RecordsDocument(
      id: newAttrs[RecordsAttrs.id] ?? id,
      date: newAttrs[RecordsAttrs.date] ?? date,
      therapist: newAttrs[RecordsAttrs.therapist] ?? therapist,
      certificate: newAttrs[RecordsAttrs.certificate] ?? certificate,
      patient: newAttrs[RecordsAttrs.patient] ?? patient,
      isMale: newAttrs[RecordsAttrs.isMale] ?? isMale,
      isPhysiotherapy:
          newAttrs[RecordsAttrs.isPhysiotherapy] ?? isPhysiotherapy,
      vitalSigns: newAttrs[RecordsAttrs.vitalSigns] ?? vitalSigns,
      warmUp: newAttrs[RecordsAttrs.warmUp] ?? warmUp,
      barrel: newAttrs[RecordsAttrs.barrel] ?? barrel,
      cadillac: newAttrs[RecordsAttrs.cadillac] ?? cadillac,
      stepChair: newAttrs[RecordsAttrs.stepChair] ?? stepChair,
      reformer: newAttrs[RecordsAttrs.reformer] ?? reformer,
      columpio: newAttrs[RecordsAttrs.columpio] ?? columpio,
      solo: newAttrs[RecordsAttrs.solo] ?? solo,
      accessories: newAttrs[RecordsAttrs.accessories] ?? accessories,
      physiotherapy: newAttrs[RecordsAttrs.physiotherapy] ?? physiotherapy,
      intercurrences: newAttrs[RecordsAttrs.intercurrences] ?? intercurrences,
      comments: newAttrs[RecordsAttrs.comments] ?? comments,
    );
  }

  Map<String, dynamic>? toMap({bool isCreate = false}) => getValidMap(
        {
          RecordsAttrs.date: date,
          RecordsAttrs.therapist: therapist,
          RecordsAttrs.certificate: certificate,
          RecordsAttrs.patient: patient,
          RecordsAttrs.isMale: isMale,
          RecordsAttrs.isPhysiotherapy: isPhysiotherapy,
          RecordsAttrs.vitalSigns: vitalSigns.toMap(isCreate: isCreate),
          RecordsAttrs.warmUp: warmUp.toMap(isCreate: isCreate),
          RecordsAttrs.barrel: barrel.toMap(isCreate: isCreate),
          RecordsAttrs.cadillac: cadillac.toMap(isCreate: isCreate),
          RecordsAttrs.stepChair: stepChair.toMap(isCreate: isCreate),
          RecordsAttrs.reformer: reformer.toMap(isCreate: isCreate),
          RecordsAttrs.columpio: columpio.toMap(isCreate: isCreate),
          RecordsAttrs.solo: solo.toMap(isCreate: isCreate),
          RecordsAttrs.accessories: accessories.toMap(isCreate: isCreate),
          RecordsAttrs.physiotherapy: physiotherapy.toMap(isCreate: isCreate),
          RecordsAttrs.intercurrences: intercurrences,
          RecordsAttrs.comments: deleteIfInvalid(comments),
        },
        isCreate: isCreate,
      );
